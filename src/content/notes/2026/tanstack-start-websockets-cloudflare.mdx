...
```ts title="src/routes/api/chat.$roomId.ts" {13-17}
...
A [full example client](https://github.com/dotnize/tanstack-websockets-cloudflare/blob/main/src/routes/index.tsx) is available at the demo repository. You can also check out the [deployed demo](https://ts-cf-websockets.mugnavo.com/) to see it in action.
