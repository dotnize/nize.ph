...
<Aside variant="caution" title="NOTE">
  This guide currently relies on Vinxi and Nitro and may not work with the latest versions of
  TanStack Start. [This will be updated
  soon.](https://github.com/TanStack/router/discussions/4576#discussioncomment-14132285)
</Aside>
